...
$( document ).on( "pagecreate", ".jqm-kms", function( event ) {
	var search,
		page = $( this ),
		that = this,
	...
	// Turn off autocomplete / correct for search
	...
	if ( $( event.target ).hasClass( "jqm-kms-search-results") ) {
...
$( document ).one( "pagecreate", ".jqm-kms", function( event ) {
